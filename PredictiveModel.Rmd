...
# Using cross validation on the lasso.
...
# Test error is 666171306659.
outlr <- glmnet(x, y, alpha = 1)
lrmodel <- predict(outlr, type = "coefficients", s = lambdalasso)[1:19,]
# The lasso model
lrmodel[lrmodel!=0]

# We would take the lasso over ridge regression model as it has the lower test error.
```
